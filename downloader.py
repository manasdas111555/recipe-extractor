            ...
            try:
                ...
                if "youtube.com" in video_url.lower() or "youtu.be" in video_url.lower():
                    if any(k in err_str for k in ["bot", "sign in", "po token", "403", "confirm"]):
                        safe_print(f"[Downloader] Detected YouTube bot challenge ({e}). Triggering instant oEmbed fallback...")
    ...
    try:
        ...
        try:
            ...
            if oembed_resp.status_code == 200:
                ...
                safe_print(f"[Downloader] Retrieved YouTube oEmbed metadata title: {oembed_data.get('title', '')}")
        except Exception:
            pass
